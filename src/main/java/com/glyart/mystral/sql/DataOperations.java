...
public interface DataOperations {
     ...
     */
    @Nullable
    <T> T queryForObject(@Language("MySQL") @NotNull String sql, ResultSetRowMapper<T> resultSetRowMapper) throws DataAccessException;
     ...
     * @throws DataAccessException if there is any problem
     */
    <T> T queryForObject(@Language("MySQL") @NotNull String sql, Object[] args, @NotNull ResultSetRowMapper<T> resultSetRowMapper) throws DataAccessException;
     ...
     * @see Types
     */
    <T> T queryForObject(@Language("MySQL") @NotNull String sql, Object[] args, ResultSetRowMapper<T> resultSetRowMapper, int... sqlTypes) throws DataAccessException;
}
