...
public interface DataOperations {
     ...
     * @return an object returned by the callback, or null if it's not available
     * @throws DataAccessException if there is any problem
     */
    @Nullable
    <T> T execute(@NotNull StatementFunction<T> callback) throws DataAccessException;
     ...
     * @throws DataAccessException if there is any problem
     */
    int update(@Language("MySQL") @NotNull String sql, boolean getGeneratedKeys) throws DataAccessException;
     ...
     * @param <T> the result type
     * @return a result object (if it exists), according to the ResultSetExtractor implementation
     * @throws DataAccessException if there is any problem
     */
    @Nullable
    <T> T query(@Language("MySQL") @NotNull String sql, ResultSetExtractor<T> extractor) throws DataAccessException;
     ...
     * @param <T> the result type
     * @return a result object (if it exists), according to the ResultSetExtractor, otherwise the result of the supplier invocation
     * @throws DataAccessException if there is any problem
     */
    @Nullable
    <T> T queryOrElseGet(@Language("MySQL") @NotNull String sql, ResultSetExtractor<T> extractor, @NotNull Supplier<T> supplier);
     ...
     * @param <T> the result type
     * @return a result list containing mapped objects (if they exist)
     * @throws DataAccessException if there is any problem
     */
    @Nullable
    <T> List<T> queryForList(@Language("MySQL") @NotNull String sql, ResultSetRowMapper<T> resultSetRowMapper) throws DataAccessException;

    /**
     * Executes a query given static SQL statement, then it maps each
     * ResultSet row to a result object using the {@link ResultSetRowMapper} implementation.<br>
     * <p>If a {@code null} collection is returned, then the given supplier will be invoked, supplying the specified list (it can be null).</p>
     * @param sql the query to execute
     * @param resultSetRowMapper a callback that will map one object per ResultSet row
     * @param supplier the supplier of another list
     * @param <T> the result type
     * @return a result list containing mapped objects (if they exist), otherwise the result of the supplier invocation
     * @throws DataAccessException if there is any problem
     */
    @Nullable
    <T> List<T> queryForListOrElseGet(@Language("MySQL") @NotNull String sql, ResultSetRowMapper<T> resultSetRowMapper, @NotNull Supplier<List<T>> supplier);
     ...
     */
    @Nullable
    <T> T queryForObject(@Language("MySQL") @NotNull String sql, ResultSetRowMapper<T> resultSetRowMapper) throws DataAccessException, IncorrectDataSizeException;
     ...
     * @param supplier the supplier of another result
     * @param <T> the result type
     * @return a mapped result object (if it exists), otherwise the result of the supplier invocation
     * @throws DataAccessException if there is any problem
     * @throws IncorrectDataSizeException if the query return more than one result
     * @see Types
     */
    @Nullable
    <T> T queryForObjectOrElseGet(@Language("MySQL") @NotNull String sql, ResultSetRowMapper<T> resultSetRowMapper, @NotNull Supplier<T> supplier) throws DataAccessException, IncorrectDataSizeException;
     ...
     */
    @Nullable
    <T> T execute(@NotNull PreparedStatementCreator creator, @NotNull PreparedStatementFunction<T> callback) throws DataAccessException;
     ...
     */
    @Nullable
    <T> T execute(@Language("MySQL") @NotNull String sql, @NotNull PreparedStatementFunction<T> callback) throws DataAccessException;
     ...
     * @throws DataAccessException if there is any problem
     */
    int update(@NotNull PreparedStatementCreator creator, boolean getGeneratedKeys) throws DataAccessException;
     ...
     * @throws DataAccessException if there is any problem
     */
    int update(@Language("MySQL") @NotNull String sql, @Nullable PreparedStatementSetter setter, boolean getGeneratedKey) throws DataAccessException;
     ...
     * @throws DataAccessException if there is any problem
     */
    int update(@Language("MySQL") @NotNull String sql, Object[] params, boolean getGeneratedKey, int... sqlTypes) throws DataAccessException;
     ...
     */
    void batchUpdate(@Language("MySQL") @NotNull String sql, @NotNull BatchSetter batchSetter) throws IllegalStateException;
     ...
     * @throws IllegalStateException If the driver doesn't support batch updates
     */
    void batchUpdate(@Language("MySQL") @NotNull String sql, @Nullable List<Object[]> batchArgs, int... sqlTypes) throws IllegalStateException;
     ...
     * @throws IllegalStateException if the driver doesn't support batch updates
     */
    <T> void batchUpdate(@Language("MySQL") @NotNull String sql, @Nullable List<T> batchArgs, @NotNull ParametrizedBatchSetter<T> paramsBatchSetter) throws IllegalStateException;
     ...
     */
    <T> T query(@NotNull PreparedStatementCreator creator, @Nullable PreparedStatementSetter setter, @NotNull ResultSetExtractor<T> extractor) throws DataAccessException;
     ...
     */
    <T> T query(@NotNull PreparedStatementCreator creator, @NotNull ResultSetExtractor<T> extractor) throws DataAccessException;
     ...
     * @param sqlTypes an integer array containing the type of the query's parameters, expressed as {@link java.sql.Types}
     * @param <T> the result type
     * @return a result object (if it exists), according to the ResultSetExtractor implementation, otherwise the result of the supplier invocation
     * @throws DataAccessException if there is any problem
     * @see Types
     */
     ...
     */
    @Nullable
    <T> T queryForObjectOrElseGet(@Language("MySQL") @NotNull String sql, Object[] args, ResultSetRowMapper<T> resultSetRowMapper, @NotNull Supplier<T> supplier, int... sqlTypes) throws DataAccessException, IncorrectDataSizeException;
}
